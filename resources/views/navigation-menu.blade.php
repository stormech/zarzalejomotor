<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 py-2">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{route('admin.images.index')}}" :active="request()->routeIs('admin.images.*')">
                        {{ __('Images') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{route('admin.roles.index')}}" :active="request()->routeIs('admin.roles.*')">
                        {{ __('Roles') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{route('admin.permissions.index')}}" :active="request()->routeIs('admin.permissions.*')">
                        {{ __('Permissions') }}
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{route('admin.permissions.index')}}" :active="request()->routeIs('admin.permissions.*')">
                {{ __('Permissions') }}
            </x-jet-responsive-nav-link>
